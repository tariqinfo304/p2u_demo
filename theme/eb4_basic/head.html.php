...
<div class="wrapper">
    ...
    <header class="header-wrap <?php if(!defined('_INDEX_')) { ?>page-header-wrap<?php } ?>">
        <div class="top-header" style="border:none;">
            <div class="container">
                <div class="row align-items-center position-relative">
                    ...
                    <a href="<?php echo G5_URL; ?>" class="title-logo">
                        ...
                        <?php } else if ($logo == 'image') { ?>
                            ...
                            <?php } else { ?>
                            <img src="<?php echo EYOOM_THEME_URL; ?>/image/header-logo.jpeg" class="site-logo" style="width:80px;" alt="<?php echo $config['cf_title']; ?>">
                            <?php } ?>
                            <?php } else { ?>
                        ...
                        <?php if ($eyoom['is_shop_theme'] == 'y') { ?>
                            ...
                            <li class="cs-nav c-nav"><a href="<?php echo G5_URL; ?>"><span class="deactivate">커뮤니티s</span></a></li>
                            ...
                            <li>    
                                <div class="header-title-search d-none d-lg-block">
                                    ...
                                    <div class="input input-button">
                                        <input type="text" name="stx" id="modal_sch_stx" class="sch_stx" style="border-radius:50px;background-color:#f1f5f9;border:none;" maxlength="20" placeholder="전체 게시판 검색">
                                        <div class="button" style="background-color:#f1f5f9;border-left:none;border-radius:50px;"><input type="submit"><i class="fas fa-search"></i></div>
                                    </div>
                                    </form>
                                </div>
                            </li>
                ...
                <nav class="navbar navbar-expand-lg">
                    <div class="sidebar-left offcanvas offcanvas-start" tabindex="-1" id="offcanvasLeft" aria-controls="offcanvasLeftLabel">
                        <div class="sidebar-left-content">
                            ...
                            ?>
                            <ul class="menu">
                                <?php foreach($menus as $single_menu_item) : ?>
                                <li class="menu-item" >
                                    <div class="menu-item-title" style="border-bottom:4px solid transparent;">
                                        <a href="<?php echo $single_menu_item['me_link'] ?>" target="<?php echo $single_menu_item['me_target'] ?>"><?php echo $single_menu_item['me_name']; ?></a>
                                    </div>
                                    <?php if(isset($single_menu_item['sub']) && !empty($single_menu_item['sub'])) : ?>
                                    <ul class="submenu">
                                        <?php foreach($single_menu_item['sub'] as $submenu): ?>
                                        <li class="submenu-item">
                                            <div style="display:flex;justify-content:space-between;">
                                                <p><?php echo $submenu['me_name']; ?></p>
                                                <p>></p>
                                            </div>
                                            <?php if(isset($submenu['children']) && !empty($submenu['children'])): ?>
                                            <ul class="subsubmenu">
                                                <?php foreach($submenu['children'] as $submenu_item) :?>
                                                <li class="subsubmenu-item">
                                                    <div style="display:flex;justify-content:space-between;">
                                                        <p><?php echo $submenu_item['title'] ?></p>
                                                        <p>></p>
                                                        <div>
                                                            <ul class="subsubsubmenu">
                                                                <?php foreach($submenu_item['children'] as $subsubmenuitem): ?>
                                                                <li><?php echo $subsubmenuitem['title'] ?></li>
                                                                <?php endforeach; ?>
                                                            </ul>
                                                        </div>
                                                    </div>
