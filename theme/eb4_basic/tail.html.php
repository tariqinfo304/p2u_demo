...
<?php if (!$wmode) { ?>
	...
	<?php /*----- footer 시작 -----*/ ?>
	<footer class="footer" style="background-color:#000;min-height:20vh;padding:30px;">
		<div class="container" style="max-width:80vw;">
				...
				<div>
					<a href="<?php echo G5_URL; ?>" class="title-logo">
						...
						<?php } else if ($logo == 'image') { ?>
							...
							<?php } else { ?>
							<img src="<?php echo EYOOM_THEME_URL; ?>/image/footer-logo.jpeg" class="site-logo" style="width:80px;" alt="<?php echo $config['cf_title']; ?>">
							<?php } ?>
							<?php } else { ?>
			...
			<div style="margin:20px 0">
				<p style="color:white;margin:5px 0;">Lorem ipsum dolor sit amet consectetur</p>
				<p style="color:grey;margin:5px 0;">Sequi odio ut numquam facere fugit rem.</p>
				<p style="color:white;margin:5px 0;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore accusamus </p>
				<p style="color:grey;margin:5px 0;">Sequi odio ut numquam facere fugit rem Lorem ipsum dolor sit amet.</p>
				<p style="color:white;margin:5px 0;">Lorem ipsum dolor sit amet consectetur Lorem, ipsum.</p>
				<p style="color:grey;margin:5px 0;">Sequi odio ut numquam facere fugit rem Lorem ipsum, dolor sit amet consectetur adipisicing elit.</p>
			</div>
			<div>
				<ul class="footer-ul" style="color:white;margin:40px 0;">
					<li>Support</li>
					<li>About</li>
					<li>Contact Us</li>
				</ul>
